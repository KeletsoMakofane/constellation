...
data.table::fwrite(organizations_nodes_unique, paste0(final.data.directory, "organization_nodes.csv"))
...
data.table::fwrite(investigators_nodes_unique, paste0(final.data.directory, "investigator_nodes.csv"))

project_nodes           <- data.table::fread(paste0(final.data.directory, "project_nodes.csv"))
project_nodes_unique    <- unique(project_nodes)
data.table::fwrite(project_nodes_unique, paste0(final.data.directory, "project_nodes.csv"))
